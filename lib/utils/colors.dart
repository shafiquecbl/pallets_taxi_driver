...
const Color primaryColor = Color(0xFFFBBA1E);
const Color primaryLight = Color(0xFFF6C443);
...
const Color hintColor = Color.fromRGBO(137, 137, 137, 1);
const Color textColorLight = Color.fromRGBO(42, 42, 42, 1);
